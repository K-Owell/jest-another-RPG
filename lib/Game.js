...
// if using a potion:
// display list of potion object to user / apply selected potion effect to player

// if attacking:
// subract health from enemy based on player attack value
    ...
    if (this.isPlayerturn) {
        ...
        .then(({ action }) => {
            if (action === 'Use potion') {
                ...
                inquirer.prompt({
                    type: 'list',
                    messagae: 'Which potion would you like to use?',
                    name: 'action',
